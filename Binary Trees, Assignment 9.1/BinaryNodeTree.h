...
protected:
	...
	//BinaryNode<ItemType>*
		//BinaryNodeTree<ItemType>::removeLeftmostNode(BinaryNode<ItemType>* nodePtr, const
...
public:
	...
	bool add(const ItemType& newData); // Adds a node in a balanced fashion
...
void BinaryNodeTree<ItemType>::attachLeft(const ItemType& anEntry) const
{
	...
	if (isEmpty())
		cout << "TreeException: Empty tree" << endl;
	else
		if (rootPtr->getLeftChildPtr() != nullptr)
			cout << "TreeException: Can not overwrite left tree" << endl;
		else {
			leftTreePtr = new BinaryNode<ItemType>(anEntry, nullptr,
				nullptr);
			rootPtr->setLeftChildPtr(leftTreePtr);
			if (rootPtr->getLeftChildPtr() == nullptr)
				cout << "TreeException: Can not allocate memory" << endl;
		} //end if
}// end attachLeft
//Funciona se corrigio
template < class ItemType>
void BinaryNodeTree<ItemType>::attachRight(const ItemType& anEntry) const
{
	...
	if (isEmpty())
		...
		if (rootPtr->getRightChildPtr() != nullptr)
			cout << "TreeException: Can not overwrite right tree" << endl;
		else {
	...
	leftTreePtr) const
{
	if (isEmpty())
		...
		if (rootPtr->getLeftChildPtr() != nullptr)
			cout << "TreeException: Can not overwrite left sub tree" << endl;
		else {
	...
	rightTreePtr) const
{
	if (isEmpty())
		...
		if (rootPtr->getRightChildPtr() != nullptr)
			cout << "TreeException: Can not overwrite right sub tree" << endl;
		else {
